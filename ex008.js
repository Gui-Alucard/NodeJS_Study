...
// Escreva na linguagem que preferir um método que recebe dois arrays “a” e “b” 
// como parâmetro e retorna um terceiro array “c” que contém todos os elementos comuns em “a” e “b”.
function newArray(arrA, arrB) {
  let arrC = arrA.filter((item) => arrB.includes(item));
  return arrC;
}

newArray([1, 2, 3, 4, 'teste'], ['teste', 3, 6]);

// Escreva na linguagem que preferir um método que recebe duas strings, A e B,
// e retorne true se B estiver contido em A. (Exs: {A = "teste", B = "st", retorna true} { A = "teste", B = "xt", retorna false})
function x(strA, strB) {
